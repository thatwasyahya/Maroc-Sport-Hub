  ...
  const onSubmit = async (data: RequestFormValues) => {
    ...
    try {
      ...
      toast({
        ...
        description: `Your request for ${data.name} has been sent for review.`,
      });
      form.reset();
      onOpenChange(false);
    } catch (error) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-3xl">
        <DialogHeader>
          <DialogTitle>Submit a New Facility Request</DialogTitle>
          <DialogDescription>
            Fill in the details of the facility you'd like to see added. Our admins will review it.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            <ScrollArea className="h-[60vh] p-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                  ...
                  render={({ field }) => (
                      <FormItem>
                      <FormLabel>Estimated Rental Cost (MAD/hr)</FormLabel>
                      <FormControl>
                  ...
                  render={({ field }) => (
                      <FormItem>
                      <FormLabel>Estimated Deposit Cost (MAD)</FormLabel>
                      <FormControl>
                          <Input type="number" {...field} />
                      </FormControl>
                      <FormMessage />
